...
genieservice_web = {
    ...
    endContent: function() {
        ...
        if (_.isUndefined(content)) return void console.log("Content is undefined", content);
    ...
    getLocalStorageContent: function() {
        ...
        return _.isUndefined(content) ? void 0 : JSON.parse(content);
    }
}, genieservice_html = {
    localData: {},
    _jsFilesToLoad: [],
...
dateFormat.masks = {
    ...
    setTelemetryService: function(localStorageInstance, gameData) {
        if (localStorageInstance._gameData.id == gameData.id) {
            var start = JSON.parse(localStorage.getItem("_start")), end = JSON.parse(localStorage.getItem("_end"));
