...
ControllerManager.registerController("items", ItemController), MCQEvaluator = {
    ...
    showFeeback: function(showOverlayGoodJob) {
        var returnVal = !0;
        return showOverlayGoodJob ? (returnVal = "on" == this._stageConfig.overlayGoodJob ? !0 : !1, 
        this.showGoodJobFb(returnVal)) : (returnVal = "on" == this._stageConfig.overlayTryAgain ? !0 : !1, 
    ...
    isStageAssetsLoaded: function(stageId) {
        ...
        return !_.isUndefined(this.loaders[stageId]) && this.loaders[stageId].stageLoaded ? !0 : _.isArray(manifest) && 0 == manifest.length ? !0 : !1;
    }
}), RecorderManager = {
...
var ThemePlugin = Plugin.extend({
    ...
    render: function() {
        console.log("ThemePlugin: dispatch renderer:show:overlay"), EkstepRendererAPI.dispatchEvent("renderer:show:overlay");
        var instance = this;
        ...
        }), this.invokeStage(this._data.startStage)), this.update(), org.ekstep.contentrenderer.progressbar(!1);
    },
    addController: function(p) {
