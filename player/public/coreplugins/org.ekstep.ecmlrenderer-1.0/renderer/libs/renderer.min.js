...
var TelemetryPlugin = Plugin.extend({
    ...
    initializeTelemetryPlugin: function() {
        if ("undefined" == typeof cordova) {
            ...
            this._requiredFields.uid = extConfig.context.uid || extConfig.uid, this._requiredFields.sid = extConfig.context.sid || CryptoJS.MD5(Math.random().toString()).toString(), 
