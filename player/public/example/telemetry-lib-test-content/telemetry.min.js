...
!function(s) {
    ...
    return this.Telemetry = function() {}, Telemetry.isActive = !1, Telemetry.config = void 0, 
    this.startTime = 0, this._defaultValue = {
        pdata: {
            id: "genie",
            "var": "6.5.2567",
            pid: ""
        ...
        if (!hasRequiredData(requiredData, [ "contentId", "contentVer", "pdata", "channel", "uid", "authtoken" ])) return void console.error("Invalid start data");
        ...
        var endeks = Object.assign(assessStartEvent.event.edata.eks, {
            ...
            mmc: data.mmc,
            mc: data.mc,
            length: Math.round((new Date().getTime() - assessStartEvent.event.ets) / 1e3)
        });
        ...
        _defaultValue.gdata = {
            id: contentId,
            ver: contentVer
        }, Telemetry.config = Object.assign(config, _defaultValue), console.log("Telemetry config ", Telemetry.config);
