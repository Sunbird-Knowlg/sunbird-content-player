Plugin.extend({
    ...
    initPlugin: function(data) {
		...
		if(data.type=="custom")
		{
			...
			var clearKey;
			clearKey = '<div class="key_barakhadi key_barakhadi_clear key_barakhadi_clear_24" id="clear_btn">&larr;</div>';
			...
			{
				clearKey = '<div class="key_barakhadi key_barakhadi_clear" id="clear_btn">&larr;</div>';
			}
			...
			for(var i=0; i<buttons.length; i++)
			{
				if(i%12 == 0){
					...
					// customKeys += '<div class="key_barakhadi" id="'+buttons[i]+'_btn">&larr;</div>';
				}
			}
