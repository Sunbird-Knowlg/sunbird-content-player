...
.directive('qsTryAgain', function($rootScope) {
	return {
		restrict: 'AE',
		template: '<div class="popup"> <div class="popup-overlay" ng-click="tryAgainHidePopup()"></div> <div class="popup-full-body"> <div class="font-lato assess-popup assess-tryagain-popup"> <div class="wrong-answer" style=" text-align: center;"> <div class="banner"> <img ng-src="assets/icons/banner2.png" height="100%" width="100%" src="assets/icons/banner2.png"> </div> <div class="sign-board"><img ng-src="assets/icons/incorrect.png" width="40%" id="incorrectButton" alt="Incorrect Icon" src="assets/icons/incorrect.png"> </div> </div> <div id="popup-buttons-container"> <div ng-click="tryAgainHidePopup();moveNextStage();" tabindex="0" aria-label="Next" role="button" class="left button ng-binding">Next</div> <div ng-click="tryAgainSameQ();" tabindex="0" aria-label="Try Again" role="button" class="right primary button ng-binding">Try Again</div> </div> </div> </div> </div>',
		link: function(scope, element, attrs) {
