TelemetryV3Manager = Class.extend({
    ...
    getConfig: function(){
      ...
      configData["dispatcher"] = isbrowserpreview || _.isUndefined(isbrowserpreview) ? org.ekstep.contentrenderer.webDispatcher : org.ekstep.contentrenderer.deviceDispatcher;
